...
export const PROJECTS: Project[] = [
  ...
  // Cinever
  {
    ...
    images: [
      {
        src: "/src/assets/images/cinever/cinever_search.png",
        alt: "Cinever - 다중 카테고리 검색",
        caption: "영화/리뷰어/감독/배우 다중 카테고리 검색",
      },
      {
        src: "/src/assets/images/cinever/cinever_movie_list.png",
        alt: "Cinever - 영화 TOP 100 리스트",
        caption: "인기 영화 TOP 100 리스트 및 Skeleton UI",
      },
      {
        src: "/src/assets/images/cinever/cinever_movie_detail.png",
        alt: "Cinever - 영화 상세 정보",
        caption: "영화 상세 정보 및 리뷰 조회",
      },
      {
        src: "/src/assets/images/cinever/cinever_user_profile.png",
        alt: "Cinever - 사용자 프로필",
        caption: "역할별 사용자 프로필 페이지",
      },
      {
        src: "/src/assets/images/cinever/cinever_admin.png",
        alt: "Cinever - 관리자 페이지",
        caption: "관리자 전용 관리 대시보드",
      },
    ],
    technicalStories: [
      {
